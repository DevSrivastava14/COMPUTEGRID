...
Day 4 — Job Creation API completed.

## Next Tasks

1. Day 5 — Job Status API
2. Introduce Redis queue
3. Introduce worker process
4. Connect queued jobs to scientific computation
